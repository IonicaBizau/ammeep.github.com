...
module Jekyll
  ...
  class FlickrPhotosetTag < Liquid::Tag
    ...
    def initialize(tag_name, markup, tokens)
      ...
      @photoClass     = @photoEmbeded.delete(" ").downcase
    end
    ...
    def render(context)
      ...
      if photos.count == 1
       ...
       # output += "  <div class=\"large-11 columns large-centered flexslider #{@photoClass}\">\n"
       # output += "    <ul class=\"clearing-thumbs slides\" data-clearing>\n"
